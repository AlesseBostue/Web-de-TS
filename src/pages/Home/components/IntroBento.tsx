...
function IntroBento() {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-6 max-w-5xl mx-auto">
      ...
      >
        <span className="absolute top-2 left-4 font-bold text-base md:text-xl text-title z-10 drop-shadow-sm mr-4">
        ...
        <span className="absolute bottom-4 left-4 text-xs text-subtitle bg-indigo-900/60 
      ...
      >
        ...
        <span className="absolute bottom-4 left-4 text-xs text-subtitle bg-red-900/60 
          rounded-xl px-2 py-0.5 z-10 group-hover:-translate-y-1 
          transition-transform duration-300 ease-in-out"
        >
          16 clubes
      ...
      >
        ...
        <span className="absolute bottom-4 left-4 text-xs text-subtitle bg-green-900/60 
          rounded-xl px-2 py-0.5 z-10 group-hover:-translate-y-1 
          transition-transform duration-300 ease-in-out"
        >
          3 torneos activos
      ...
      >
        ...
        <span className="absolute bottom-4 left-4 text-xs text-subtitle bg-purple-900/60 
          rounded-xl px-2 py-0.5 z-10 group-hover:-translate-y-1 
          transition-transform duration-300 ease-in-out"
        >
          Soporte 24/7
